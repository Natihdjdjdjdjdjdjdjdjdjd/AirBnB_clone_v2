test_amenity.py
#!/usr/bin/python3
""" lets the amendity check the test amenity """
...
class test_inherit_basemodel(unittest.TestCase):
    """lets check the inhert based_seModel"""
    def test_instance(self):
        """let the taset check the instnance of BaseModel"""
        user = Amenity()
...
class test_Amenity_BaseModel(unittest.TestCase):
    """ amendity test for the cheking user class"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """test that  returned from to_dict are correct"""
    ...
    def test_str(self):
        """lets check the str method to correct output"""
        amenity = Amenity()
