test_base_model.py
#!/usr/bin/python3
""" lets test our base model class """
...
class test_basemodel(unittest.TestCase):
    ...
    def test_pycodestyle(self):
        """
        let tes our pyscod styleein this
        """
    ...
    def test_default(self):
        """let the func test the defalut """
        i = self.value()
        self.assertEqual(type(i), self.value)

    def test_kwargs(self):
        """lets check the kwarg test """
        i = self.value()
        copy = i.to_dict()
        new = BaseModel(**copy)
